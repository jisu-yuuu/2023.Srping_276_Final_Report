...
rt_daily = read.csv(file = "rt_daily_mod.csv")
wts_ptf_monthly = read.csv("portfolio_weights_months_mod.csv")
...
plot(val_ptf_daily_no_fee,main="Moderate Portfolio Value (Fee Excluded)",col = rgb(0,0,0), legend = "asdf", ylab = "unit price")
...
plot(val_ptf_daily_no_fee,main="Moderate Portfolio Value against SP500",col = rgb(0,0,0), legend = "asdf", ylab = "unit price")
...
plot(rt_std_SP_daily, main = "Portfolio Return against S.D of SP500",ylim=c(0,0.05))
...
plot(MDD_daily, type = "l", main = "Maximum Draw-Down with 60-day window", ylab = "MDD",ylim =c(0,0.4) )
xts::addLegend("topleft", on=1, 
               legend.names = "MDD", 
               lty=1, lwd=1,
               col="black")
...
plot(sd_ptf_daily, main = "Portfolio standard deviation over 60-day window", ylim=c(0,0.05))
plot(Sharpe_ptf_daily, main = "Portfolio Sharpe Ratio over 60-day window",ylim=c(-0.3,0.4))
...
tickers_selected = read.csv("tickers_mod.csv")
